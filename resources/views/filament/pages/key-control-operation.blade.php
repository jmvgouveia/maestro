<x-filament-panels::page>
    <div class="porter-page space-y-6">
        ...
        <div class="porter-stat-grid">
            ...
            <button type="button" wire:click="$set('selectedStatus', null)" class="porter-stat-card porter-stat-total {{ $selectedStatus === null ? 'is-selected' : '' }}" aria-pressed="{{ $selectedStatus === null ? 'true' : 'false' }}">
                <span class="porter-stat-icon"><x-heroicon-o-building-office-2 class="h-5 w-5" /></span><p>Total de salas</p><strong>{{ $this->authorizedRoomsCount }}</strong>
            </button>
        </div>
        ...
        <div class="porter-toolbar">
            <div class="porter-filters">
                <label for="room-search" class="porter-search">
                    ...
                    <input id="room-search" type="search" wire:model.live.debounce.300ms="search" placeholder="Pesquisar sala, edifício ou utilizador..." autocomplete="off">
                </label>
    ...
    <style>
        ...
        .porter-stat-card.is-selected { border-color: #063b82; background: #eff6ff; box-shadow: 0 0 0 2px rgb(6 59 130 / 12%); }
        ...
        .porter-room-card-action:active { transform: translateY(0); }
        .porter-room-card.is-available { background: #fbfffc; }
        .porter-room-card.is-occupied { background: #fffafb; border-top-color: #dc2626; }
        ...
        .porter-room-details { min-height: 3.75rem; margin: 1rem 0 .65rem; color: #475569; font-size: .8rem; }
        ...
        .porter-available-copy { display: flex; align-items: center; gap: .7rem; padding-top: .65rem; color: #15803d; font-weight: 650; }
        .porter-key-avatar { width: 2.75rem; height: 2.75rem; color: #15803d; background: #dcfce7; }
        ...
        .dark .porter-room-card.is-available { background: #102018; }
        .dark .porter-room-card.is-occupied { background: #211619; border-top-color: #ef4444; }
        .dark .porter-stat-card.is-selected { background: #12233d; border-color: #60a5fa; }
        .dark .status-available { color: #86efac; background: #14532d; }
        .dark .status-occupied { color: #fca5a5; background: #7f1d1d; }
        .dark .porter-holder-badge.is-teacher { color: #bfdbfe; background: #1e3a8a; }
        .dark .porter-holder-badge.is-student { color: #fdba74; background: #7c2d12; }
        .dark .porter-holder-avatar.is-student { color: #fdba74; background: #7c2d12; }
        ...
        .key-control-operation-modal { border-radius: 1.5rem !important; scrollbar-gutter: stable; scrollbar-width: thin; scrollbar-color: #94a3b8 transparent; }
